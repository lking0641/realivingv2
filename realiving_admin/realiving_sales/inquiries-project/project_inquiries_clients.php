...
<div class="app-wrap">
  ...
  <div class="top-bar">
    ...
    <a href="project_inquiries_dashboard.php" class="nav-btn back"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
  </div>
  ...
  <div class="tab-content active" id="content-pending">
    <div class="section-card">
      <div class="section-head">
        <h2><i class="fas fa-clock" style="color:#f59e0b;"></i> Responded Project Inquiries — Ready to Convert</h2>
      </div>
