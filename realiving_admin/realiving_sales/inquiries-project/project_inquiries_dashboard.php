...
<body>
        ...
        <div>
          ...
          <div class="section-card">
            <div class="section-head">
              <h2><i class="fas fa-building" style="color:#6366f1;"></i> Recent Project Inquiries
                <span
          ...
          <div class="section-card">
            ...
            <div class="section-body" style="display:flex;flex-direction:column;gap:10px;">
              ...
              <a href="../../projects" target="_blank" class="btn btn-outline"
                style="justify-content:flex-start;color:var(--purple);border-color:#c4b5fd;"><i
  ...
  <script>
    ...
    <div style="margin-top:14px;padding:12px;background:var(--purple-bg);border-radius:var(--radius-sm);border:1px solid #c4b5fd;">
