...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $target_dir = ROOT_PATH . "realiving_user/images/project_locations/";
    ...
    if ($action === 'delete_image') {
        ...
        if ($image) {
            ...
            if ($stmt->execute()) {
                // Delete file
                $file_path = ROOT_PATH . "realiving_user/" . $image['image_path'];
...
<body class="bg-gray-50 p-8">
    <div class="max-w-7xl mx-auto">
        <div class="mb-6">
            <a href="project-locations?project_id=<?php echo $location['project_id']; ?>" class="text-primary hover:text-secondary flex items-center space-x-2 mb-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <?php while ($image = $images->fetch_assoc()): 
                $img_path = CLIENT_ASSET . '/' . $image['image_path'];
            ?>
