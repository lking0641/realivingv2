...
<head>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <a href="<?php echo BASE_URL; ?>projects-dashboard" class="text-primary hover:text-secondary flex items-center space-x-2 mb-4">
    ...
    <div class="flex items-center justify-between">
        <a href="view-projects?id=<?php echo $project['id']; ?>" target="_blank" class="text-primary hover:text-secondary text-sm font-medium flex items-center">
    ...
    <a href="project-locations?project_id=<?php echo $project['id']; ?>" class="block w-full text-center bg-amber-50 hover:bg-amber-100 text-amber-700 py-2 rounded-lg text-sm font-medium transition-colors">
