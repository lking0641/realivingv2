...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['background_image']) && $_FILES['background_image']['error'] === 0) {
        $target_dir = ROOT_PATH . "/images/building_types/";
    ...
    if (isset($_FILES['background_image']) && $_FILES['background_image']['error'] === 0) {
        $target_dir = ROOT_PATH . "/realiving_user/images/building_types/";
        if (!file_exists($target_dir)) {
            mkdir($target_dir, 0777, true);
        }
        ...
        if (!empty($background_image)) {
            $old_file = ROOT_PATH . "/realiving_user/" . $background_image;
    ...
    if ($stmt->execute()) {
        ...
        if (!empty($img_result['background_image'])) {
            $file_path = ROOT_PATH . "realiving_user/" . $img_result['background_image'];
...
<head>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <a href="gallery-dashboard" class="text-indigo-600 hover:text-indigo-800 flex items-center space-x-2 mb-4">
    ...
    if (type.background_image) {
        ...
        img.src = '<?= CLIENT_ASSET ?>/' + type.background_image;
