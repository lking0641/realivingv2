...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create_collection') {
        ...
        if ($stmt->execute()) {
            ...
            $target_dir = ROOT_PATH . "realiving_user/images/gallery/";
    ...
    if ($action === 'delete_collection') {
        ...
        while ($img = $imgs->fetch_assoc()) {
            $fp = ROOT_PATH . "realiving_user/" . $img['image_path'];
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <a href="gallery-dashboard" class="inline-flex items-center gap-1.5 text-sm text-purple-600 hover:text-purple-800 mb-3 transition-colors">
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <?php foreach ($cols as $col):
                        ...
                        $preview_stmt->close();
                        $preview_disk = $preview ? ROOT_PATH . 'realiving_user/' . ltrim($preview['image_path'], './') : '';
$preview_img  = $preview ? CLIENT_ASSET . '/' . ltrim($preview['image_path'], './') : '';
                    ...
                    ?>
                        <div class="collection-card bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                            ...
                            <div class="relative h-36 bg-gray-100 overflow-hidden">
                                <?php if ($preview_img && file_exists($preview_disk)): ?>
                            ...
                            <div class="p-3">
                                ...
                                <div class="flex items-center justify-between pt-2 border-t border-gray-100 mt-2">
                                    <a href="manage-collection-details?id=<?php echo $col['id']; ?>"
                                    ...
                                    <form method="POST" action="manage-collections<?php echo $filter_redirect; ?>" onsubmit="return confirm('Delete this collection and all <?php echo $col['image_count']; ?> images?');" class="inline delete-collection-form">
...
<div id="createModal" class="modal">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl mx-4 p-7">
        ...
        <form method="POST" action="manage-collections<?php echo $filter_redirect; ?>" enctype="multipart/form-data" id="createCollectionForm">
...
<div id="connectionsModal" class="modal">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 p-7">
        ...
        <form method="POST" action="manage-collections<?php echo $filter_redirect; ?>" id="connectionsForm">
