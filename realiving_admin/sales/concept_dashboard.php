        ...
        <div class="management-grid">
            ...
            <div class="management-card">
                <div class="card-header">
                    <h2>Page Header</h2>
                    <a href="concept_manage_header.php" class="btn btn-primary">Edit Header</a>
                </div>
                <div class="card-body">
                    <?php if ($header_data): ?>
                    <div class="header-preview" style="background-image: url('../../realiving_user/<?php echo htmlspecialchars($header_data['header_image']); ?>')">
            ...
            <div class="management-card">
                <div class="card-header">
                    <h2>Design Styles</h2>
                    <a href="concept_manage_styles.php" class="btn btn-success">Manage Styles</a>
                </div>
                <div class="card-body">
    ...
    <span class="badge badge-primary"><?php echo $style['layout_type']; ?></span>
            ...
            <div class="management-card">
                <div class="card-header">
                    ...
                    <a href="concept_manage_carousel.php" class="btn btn-success">Manage Carousel</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="items-list">
                        ...
                        <div class="item-preview">
                            <img src="../../realiving_user/<?php echo htmlspecialchars($carousel['image_path']); ?>" class="item-image" alt="">
                            <div class="item-info">
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                ...
                <a href="concept_manage_styles.php" class="action-btn">
                    <span class="action-icon">➕</span>
                    <span>Add New Style</span>
                </a>
                <a href="concept_manage_carousel.php" class="action-btn">
                    <span class="action-icon">🖼️</span>
