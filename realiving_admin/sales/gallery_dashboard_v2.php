        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <a href="../sales/sales_dashboard.php" class="text-white/80 hover:text-white transition-colors">
...
<div class="p-4 bg-green-50 rounded-lg">
    <p class="text-sm text-green-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="manage_building_types.php" class="block group">
            ...
            <!-- Manage Themes -->
<a href="manage_themes.php" class="block group">
    <div class="bg-white rounded-xl shadow-sm border-2 border-gray-200 p-6 hover:shadow-lg hover:border-green-500 transition-all duration-300">
        ...
        <div class="flex items-center space-x-2 text-sm">
            ...
            <!-- Manage Collections -->
            <a href="manage_collections.php" class="block group">
