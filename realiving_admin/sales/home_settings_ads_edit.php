...
if (!$item) {
    header("Location: home_settings_ads_content_view.php?error=notfound");
    exit();
}
        ...
        if (!$sched_valid) {
            ...
            if (empty($error_message)) {
                ...
                if ($stmt->execute()) {
                    ...
                    if ($is_today_sched) {
                        header("Location: home_settings_ads_content_view.php?success=updated");
                    } else {
                        header("Location: home_settings_ads_content_view.php?success=updated");
                    }
                    exit();
...
$display_path    = "../../realiving_user/images/ads_content/" . basename($item['filepath']);
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Header -->
    <div class="mb-6">
        <a href="home_settings_ads_content_view.php"
