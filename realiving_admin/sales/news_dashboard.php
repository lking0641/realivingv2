    ...
    <div class="dashboard-container">
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                <a href="news_manage.php" class="action-btn">
                    <span class="action-icon">➕</span>
                    <span>Add New Article</span>
                </a>
                <a href="news_manage_header.php" class="action-btn">
                ...
                <a href="../news.php" class="action-btn" target="_blank">
                    <span class="action-icon">👁️</span>
            ...
            <div style="display: flex; flex-direction: column; gap: 25px;">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Page Header</h2>
                        <a href="news_manage_header.php" class="btn btn-primary btn-sm">Edit Header</a>
                    </div>
                    <div class="card-body">
                        <?php if ($header_data): ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="news_manage.php" class="btn btn-success btn-sm">View All</a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="news-list">
                            ...
                            <div class="news-item">
                                <img src="../../realiving_user/<?php echo htmlspecialchars($news['image']); ?>" class="news-image" alt="">
