...
<body class="bg-gray-50 p-8">
    <div class="max-w-7xl mx-auto">
        <div class="mb-6">
            <a href="projects_view.php" class="text-primary hover:text-secondary flex items-center space-x-2 mb-4">
            ...
            <?php while ($location = $locations->fetch_assoc()): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <a href="project_location_images.php?location_id=<?php echo $location['id']; ?>" class="block w-full text-center bg-primary hover:bg-secondary text-white py-2.5 rounded-lg font-medium transition-colors">
