...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <!-- All Projects Card -->
            <a href="projects_view.php?category=all" class="block group">
            ...
            <!-- Site Projects Card -->
            <a href="projects_view.php?category=site" class="block group">
            ...
            <a href="projects_view.php?category=residential" class="block group">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="projects_view.php?action=add" class="flex items-center space-x-3 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary hover:bg-indigo-50 transition-all group">
                ...
                <a href="projects_cabinet_cost_settings.php" class="flex items-center space-x-3 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary hover:bg-indigo-50 transition-all group">
                ...
                <a href="projects_view.php" class="flex items-center space-x-3 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary hover:bg-indigo-50 transition-all group">
