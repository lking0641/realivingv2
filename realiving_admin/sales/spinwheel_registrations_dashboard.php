  ...
  <div class="pt-10 pb-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between flex-wrap gap-4 mb-3">
        ...
        <!-- Scanner Button -->
        <a href="../spin_wheel/spinwheel_claim_scanner.php"
        ...
        <!-- Promo Toggle -->
        <form method="POST" action="toggle_spinwheel.php" class="flex items-center gap-3 bg-white px-4 py-3 rounded-xl shadow-sm border border-gray-100">
    ...
    <details class="mb-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" id="wheelSettings">
      ...
      <div class="px-6 pb-6 border-t border-gray-100">
        ...
        ?>
        <form method="POST" action="update_spinwheel_segment.php" class="flex items-center gap-3 mb-2 flex-wrap">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
          ...
          <form method="POST" action="update_spinwheel_segment.php" class="flex items-center gap-3 flex-wrap">
...
<details class="mb-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" id="pitySettings">
  ...
  <div class="px-6 pb-6 border-t border-gray-100">
    ...
    <div class="flex items-center gap-3 bg-gray-50 rounded-lg px-4 py-3 mb-4 mt-3">
      ...
      <form method="POST" action="update_pity_settings.php" class="ml-auto">
    ...
    ?>
    <form method="POST" action="update_pity_settings.php" class="flex items-center gap-3 mb-2 flex-wrap bg-gray-50 rounded-lg px-3 py-2">
      <input type="hidden" name="action" value="update">
    ...
    <div class="mt-4 pt-4 border-t border-gray-100">
      ...
      <form method="POST" action="update_pity_settings.php" class="flex items-center gap-3 flex-wrap">
        <input type="hidden" name="action" value="insert">
    ...
    <div class="mb-6">
      <form method="GET" action="" class="flex gap-3">
        ...
        <?php if (!empty($search)): ?>
          <a href="spinwheel_registrations_dashboard.php" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-semibold text-sm hover:bg-gray-200 transition-colors flex items-center">
            ...
            <?php if ($result && $result->num_rows > 0): ?>
              <?php $i = 1; while ($row = $result->fetch_assoc()): ?>
                <tr class="table-row transition-colors">
                  ...
                  <td class="px-6 py-4">
                    <a href="delete_spinwheel.php?id=<?php echo $row['id']; ?>"
