...
$sql = "SELECT id, full_name, admin_name, email, role, account_status, is_online, is_head, last_activity, created_at, profile_picture, google_picture, avatar_source FROM account";
if (!empty($where)) {
              ...
              <tr id="row-<?= $a['id'] ?>">
                ...
                <td>
                  <div class="adm-row-actions">
                    <a href="<?= BASE_URL ?>admin-view?id=<?= $a['id'] ?>" class="adm-icon-btn" title="View">
