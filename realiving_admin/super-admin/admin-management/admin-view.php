...
<head>
  ...
  <title>View Admin - RealLiving</title>
  ...
  <div class="pt-10 pb-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto w-full">
    ...
    <div class="mb-8 adm-fade flex items-start justify-between flex-wrap gap-4">
      <div>
        ...
        <h1 class="adm-title">Admin Profile</h1>
      ...
      <div class="flex gap-2">
        ...
        <?php if ($admin['id'] != $current_admin_id): ?>
          <a href="<?= BASE_URL ?>admin-edit?id=<?= $admin['id'] ?>" class="adm-btn adm-btn-dark"><i class="fas fa-pen"></i> Edit</a>
        <?php endif; ?>
      </div>
    </div>
      ...
      <div class="flex items-center gap-4 flex-wrap">
        ...
        <div class="flex-1" style="min-width:200px;">
          <div style="font-size:19px; font-weight:700;">
            ...
            <?php endif; ?>
            <?php if ($admin['id'] == $current_admin_id): ?>
              <span style="font-size:12px; color: var(--adm-soft); font-weight:400;">(You)</span>
            <?php endif; ?>
          </div>
    ...
    <div class="adm-card adm-fade">
      ...
      <div id="doc-list">
        <p style="margin:0; font-size:13px; color: var(--adm-soft);">Loading documents...</p>
      </div>
    </div>
      ...
      fetch('<?= BASE_URL ?>get-employee-documents?account_id=' + EMPLOYEE_ID)
        ...
        .then(data => {
          ...
          if (!data.success || !data.documents.length) {
            list.innerHTML = '<p style="margin:0; font-size:13px; color: var(--adm-soft);">No documents uploaded yet.</p>';
            return;
          }
