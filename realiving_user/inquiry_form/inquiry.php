...
<div id="popupForm" class="hidden fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm p-5">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-7 sm:p-10 animate-fadeIn relative">
        <span id="closeFormBtn" class="absolute top-5 right-6 text-2xl text-gray-800 cursor-pointer hover:text-black sm:top-4 sm:right-4">&times;</span>
        
        <h2 class="font-serif text-2xl text-center text-amber-950 mt-0 mb-6 sm:text-3xl">Send an Inquiry</h2>
